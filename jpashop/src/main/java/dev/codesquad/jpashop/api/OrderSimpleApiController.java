...
import dev.codesquad.jpashop.repository.order.simplequery.OrderSimpleQueryDto;
import dev.codesquad.jpashop.repository.order.simplequery.OrderSimpleQueryRepository;
...
public class OrderSimpleApiController {
    ...
    public List<OrderSimpleQueryDto> ordersV2() {
        ...
        List<OrderSimpleQueryDto> result = orders.stream()
            .map(o -> new OrderSimpleQueryDto(o)).collect(Collectors.toList());
        return result;
    }
